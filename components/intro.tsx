...
export default function Intro() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-purple-600 via-blue-400 to-pink-500 p-8">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between w-full max-w-4xl rounded-lg p-6 transform hover:scale-105 transition duration-300 ease-in-out">
        <div className="flex flex-col gap-6 w-full lg:w-3/5">
          <h1 className="text-5xl font-extrabold text-gray-700 mb-2 hover:underline transition-all duration-300 ease-in-out transform hover:text-blue-500 hover:scale-105">
            Hi,👋 I&apos;m Sufyan
          </h1>

          <p className="text-base font-semibold text-gray-900 leading-relaxed p-4  rounded-lg shadow-md transition-all duration-300 hover:shadow-lg">
            ...
            Metaverse. Passioniate About Technology And Constantly Learning New
