    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-purple-600 via-blue-400 to-pink-500 p-8">
      ...
      <div className="bg-white shadow-lg rounded-lg p-6 w-full max-w-4xl transform hover:scale-105 transition duration-300 ease-in-out">
        <ul className="space-y-6">
          <li className="hover:bg-gray-200 border-b pb-4 rounded-lg transition duration-300">
            <h3 className="text-2xl font-semibold text-gray-700">
              <a href="https://sufyan-resume-builder.netlify.app" target="_blank" rel="noopener noreferrer" className="hover:underline text-blue-500">
                dynamic resume builder
              </a>
            </h3>
            <p className="text-gray-800 mt-2">
          ...
          <li className="hover:bg-gray-200 border-b pb-4 rounded-lg transition duration-300">
            <h3 className="text-2xl font-semibold text-gray-700">
              <a href="https://sufyan-giaic-page.netlify.app/" target="_blank" rel="noopener noreferrer" className="hover:underline text-blue-500">
                GIAIC web page
              </a>
            </h3>
            <p className="text-gray-800 mt-2">
          ...
          <li className="hover:bg-gray-200 border-b pb-4 rounded-lg transition duration-300">
            <h3 className="text-2xl font-semibold text-gray-700">
              <a href="https://github.com/sufyangoraya/atm_machine" target="_blank" rel="noopener noreferrer" className="hover:underline text-blue-500">
                cli atm machene
              </a>
            </h3>
            <p className="text-gray-800 mt-2">
          ...
          <li className="hover:bg-gray-200 border-b pb-4 rounded-lg transition duration-300">
            <h3 className="text-2xl font-semibold text-gray-700">
              <a href="https://github.com/sufyangoraya/word_counter" target="_blank" rel="noopener noreferrer" className="hover:underline text-blue-500">
                cli word conter
              </a>
            </h3>
            <p className="text-gray-800 mt-2">
          ...
          <li className="hover:bg-gray-200 border-b pb-4 rounded-lg transition duration-300">
            <h3 className="text-2xl font-semibold text-gray-700">
              <a href="https://github.com/sufyangoraya/cli_number_cassing_game" target="_blank" rel="noopener noreferrer" className="hover:underline text-blue-500">
                cli number guessing game
              </a>
            </h3>
            <p className="text-gray-800 mt-2">
          ...
          <li className="hover:bg-gray-200 border-b pb-4 rounded-lg transition duration-300">
            <h3 className="text-2xl font-semibold text-gray-700">
              <a href="https://github.com/sufyangoraya/simple_calculculator" target="_blank" rel="noopener noreferrer" className="hover:underline text-blue-500">
                simple calculator
              </a>
            </h3>
            <p className="text-gray-800 mt-2">
          ...
          <li className="hover:bg-gray-200 border-b pb-4 rounded-lg transition duration-300">
            <h3 className="text-2xl font-semibold text-gray-700">
              <a href="https://github.com/sufyangoraya/currency_converter" target="_blank" rel="noopener noreferrer" className="hover:underline text-blue-500">
                currency converter
              </a>
            </h3>
            <p className="text-gray-800 mt-2">
          ...
          <li className="hover:bg-gray-200 border-b pb-4 rounded-lg transition duration-300">
            <h3 className="text-2xl font-semibold text-gray-700">
              <a href="https://github.com/sufyangoraya/todo-list" target="_blank" rel="noopener noreferrer" className="hover:underline text-blue-500">
                todo list app
              </a>
            </h3>
            <p className="text-gray-800 mt-2">
